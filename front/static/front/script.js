...
(function () {
 ...
 button.addEventListener("click", function(){
                         ...
                         c.textContent = parseInt(a.value)*parseInt(b.value)
 ...
 button1.addEventListener("click", function(){
                          console.log('helloq');
                          // c.value = parseInt(a.value)*parseInt(b.value)
                          res.textContent = 'Ð’ ÐºÐ¾Ð»Ð¾Ð´Ñƒ '+deck.value +' Ð´Ð¾Ð±Ð°Ð²Ð»ÐµÐ½Ð¾ ÑÐ»Ð¾Ð²Ð¾ '+ word.value
                          console.log(parseInt(a.value)*parseInt(b.value))
                          
                          })
 
 // var ids = ["player-one", "player-two"]
 
 // var players = []
 // players.push({"id": player-one, "btn": document.getElementsByTagName("button")[0]})
 // players.push({"id": player-two, "btn": document.getElementsByTagName("button")[1]})
 
 // var scoreInput = document.getElementsByTagName("input")[0];
 // var maxScore = parseInt(document.getElementById("max-score").textContent);
 // console.log(maxScore);
 
 // function scoreIncrease(text, buttons){
 //     console.log(maxScore);
 //     if (parseInt(text.textContent) < maxScore){
 //         console.log('hello2');
 //         text.textContent = parseInt(text.textContent)+1
 //         if (text.textContent == maxScore){
 //             buttons[0].disabled = true;
 //             buttons[1].disabled = true;
 //             text.classList.toggle("winner");
 //         }
 //     }
 // }
 ...
 //     console.log('hello');
 //     scoreIncrease(playerOne, buttons);
 // })
 ...
 //     scoreIncrease(playerTwo, buttons);
 // })
 ...
 //     document.getElementById("max-score").textContent = parseInt(this.value);
